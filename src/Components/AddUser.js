...
export default class AddUser extends Component {
    ...
    showBtn = () => {
        if(this.state.stt === true){
            ...
            return <div onClick={() => this.changeState()} className="btn btn-block btn-outline-secondary">Đóng</div>
        }else{
            return <div onClick={() => this.changeState()} className="btn btn-block btn-outline-info">Thêm mới</div>
        }
    }
    showBtnAdd = () => {
